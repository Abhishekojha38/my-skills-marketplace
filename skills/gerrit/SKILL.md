---
name: gerrit
description: Submit, amend, and review Gerrit changes using git-review CLI. Use when asked to submit a patchset/changeset, download a change, rebase a change request, check CR status, or manage code reviews in Gerrit.
metadata:
  author: Abhishekojha38
  version: "1.0.0"
  category: code-hosting
  tags: "code-review, patches"
license: MIT
allowed-tools: Bash, git-review, git, ssh
---

# Gerrit Skill

This skill provides Gerrit code review integration using `git-review`. Action commands (submit, review, abandon, amend, cherry-pick, etc.) should use `git-review` or SSH commands directly.
